      ...
      <AnimatePresence>
        {!scrolled && (
          <motion.div
            ...
            /* CHANGED: Moved from 15vh to 10vh to push it even higher up into the center gap */
            className="fixed top-[10vh] left-0 right-0 z-[60] flex justify-center pointer-events-none"
          >
