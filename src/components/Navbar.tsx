      ...
      <AnimatePresence>
        {!scrolled && (
          <motion.div
            ...
            /* CHANGED: Set mobile to top-[8vh] to pull it up, kept desktop at top-[10vh] */
          ...
          >
            <a href="#hero" className="pointer-events-auto">
              {/* CHANGED: Shrunk mobile size to h-40 so it doesn't overlap text, kept desktop at h-96 */}
